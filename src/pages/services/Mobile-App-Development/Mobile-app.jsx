...
const MobileApp = () => {
  ...
  const metaPropsData = {
    title:
      "Custom Mobile App Solutions in Chennai | Aitals Technologies",
    description:
      "Aitals Technologies in Chennai offers professional mobile app development services, including native and cross-platform apps, React Native, Flutter, and secure mobile solutions.",
    keyword:
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0d1933] pt-16">
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(16, 2, 50, 0.9), rgba(16, 2, 50, 0.8)), url("https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")`,
          }}
        ></div>
