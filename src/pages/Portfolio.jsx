...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      portfolioLink: '/portfolios/travel-app.html',
  ...
  const fallbackImages = {
    'FinTech Dashboard': 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    'Healthcare Mobile App': 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    'E-Learning Platform': 'https://images.unsplash.com/photo-1501504905252-473c47e087f8?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    'Fashion E-commerce': 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    'Fitness Tracking App': 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    'Restaurant Booking System': 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    'Travel App Redesign': 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    'Real Estate Platform': 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80'
  };

  const handleImageError = (e, projectTitle) => {
    e.target.src = fallbackImages[projectTitle] || 'https://images.unsplash.com/photo-1572177812156-58036aae439c?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80';
  };
    ...
    <>
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <p className="text-gray-600 text-sm sm:text-base mb-3 sm:mb-4 line-clamp-2">{project.description}</p>

                  <div className="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4">
                    {project.tech.map((tech, idx) => (
                      <span key={idx} className="px-2 sm:px-3 py-1 bg-purple-50 text-purple-600 rounded-full text-xs sm:text-sm">
                        {tech}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="pt-3 sm:pt-4 border-t border-gray-200">
                    <p className="text-xs sm:text-sm font-medium text-green-600">✓ {project.results}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 gradient-text">Our Impact in Numbers</h2>
            <p className="text-lg sm:text-xl text-gray-600">Real results for real businesses</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto">
            {[
              ...
              >
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold gradient-text mb-2">{stat.number}</div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            ...
            className="text-center mb-12 sm:mb-16"
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 gradient-text">Client Testimonials</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {[
              ...
              >
                ...
                <p className="text-gray-700 italic mb-4 sm:mb-6 text-sm sm:text-base">"{testimonial.text}"</p>
