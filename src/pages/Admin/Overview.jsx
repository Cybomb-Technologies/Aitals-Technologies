...
import { Users, Mail, Briefcase, BookOpen, TrendingUp, Eye, Download, RefreshCw, AlertCircle } from 'lucide-react';
  ...
  const statCards = [
    {
      ...
      icon: TrendingUp,
      color: 'bg-blue-500',
      change: calculateChange(stats.enquiries, Math.round(stats.enquiries * 0.88)),
      trend: 'up',
    ...
    },
    {
      ...
      icon: Mail,
      color: 'bg-green-500',
      change: calculateChange(stats.contacts, Math.round(stats.contacts * 0.92)),
      trend: 'up',
    ...
    },
    {
      ...
      icon: Users,
      color: 'bg-purple-500',
      change: calculateChange(stats.applications, Math.round(stats.applications * 0.77)),
      trend: 'up',
    ...
    },
    {
      ...
      icon: Briefcase,
      color: 'bg-indigo-500',
      change: calculateChange(stats.jobOpenings, Math.round(stats.jobOpenings * 0.85)),
      trend: 'up',
  ...
  if (loading && recentActivities.length === 0) {
    return (
      <div className="flex justify-center items-center h-64">
        ...
        <span className="text-lg font-medium text-gray-900">Loading Dashboard...</span>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-blue-100 opacity-90">
                Here's what's happening with your website today. You have {stats.total} total interactions this month.
              </p>
            </div>
            <button
              ...
              recentActivities.slice(0, 5).map((activity, index) => (
                <div key={index} className="flex items-start space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                  <div className={`w-2 h-2 mt-2 rounded-full flex-shrink-0 ${
                    ...
                    activity.type === 'contact' ? 'bg-green-500' : 'bg-orange-500'
                  }`}></div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-medium block">View Enquiries</span>
            </button>
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-medium block">Manage Jobs</span>
            </button>
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-medium block">Write Blog</span>
            </button>
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-medium block">Applications</span>
            </button>
          </div>
        </div>
      </div>
