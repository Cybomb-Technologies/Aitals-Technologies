...
const Services = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section - Updated with About.jsx styling */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0d1933] pt-16">
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(16, 2, 50, 0.9), rgba(16, 2, 50, 0.8)), url("https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80")`,
          }}
        ></div>
          ...
          >
            {services.map((service, index) => (
              <motion.div
                ...
                className={`bg-white rounded-2xl border border-gray-200 transition-all duration-400 hover:-translate-y-3 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 hover:border-[#362B6A] relative overflow-hidden group font-['Poppins'] ${
                  index % 2 === 0 ? "" : "lg:flex-row-reverse"
                }`}
              >
                {/* Shimmer effect on hover */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#362B6A]/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center p-8 lg:p-12">
                  {/* Content */}
                  <div
                  ...
                  >
                    {/* Icon Container */}
                    <div className="w-20 h-20 bg-gradient-to-br from-[#362B6A] to-[#5355A0] rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/30 transition-all duration-500 group-hover:scale-110 group-hover:rotate-5 relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                      <service.icon className="text-white" size={24} />
                    </div>

                    {/* Title */}
                    <h2 className="text-3xl lg:text-4xl font-extrabold text-gray-800 mb-6 font-['Poppins'] leading-tight relative inline-block group-hover:text-[#362B6A] transition-colors duration-300">
                      {service.title}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {service.features.map((feature, idx) => (
                        <motion.div
                          ...
                          className="flex items-start gap-3 p-3 rounded-xl bg-gray-50/70 transition-all duration-300 hover:bg-white hover:border hover:border-[#362B6A]/20 hover:translate-x-1 group/feature"
                        >
                          <CheckCircle
                    ...
                    <Link to={service.link}>
                      <button className="relative bg-black border border-white text-white text-lg px-10 py-5 rounded-xl font-semibold transition-all duration-300 hover:shadow-2xl hover:shadow-white/30 hover:scale-105 group font-['Poppins'] inline-flex items-center gap-3 overflow-hidden">
            ...
            >
              {processSteps.map((step, index) => (
                <motion.div
                  ...
                  className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 text-center transition-all duration-400 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 hover:border-[#362B6A] relative overflow-hidden group font-['Poppins']"
                >
                  ...
                  {/* Icon */}
                  <div className="w-16 h-16 bg-gradient-to-br from-[#362B6A] to-[#5355A0] rounded-full flex items-center justify-center text-white text-2xl mb-6 mx-auto transition-all duration-700 group-hover:scale-110 group-hover:rotate-360">
                    {step.icon}
                  </div>

                  {/* Title */}
                  <h3 className="text-xl font-bold text-gray-800 mb-3 font-['Poppins'] group-hover:text-[#362B6A] transition-colors duration-300">
                    {step.title}
                  </h3>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-[#100232] relative overflow-hidden">
        <div
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <Link to="/contact">
              <button className="relative bg-black border border-white text-white text-lg px-12 py-6 rounded-xl font-semibold transition-all duration-300 hover:shadow-2xl hover:shadow-white/30 hover:scale-105 group font-['Poppins'] inline-flex items-center gap-3 overflow-hidden">
